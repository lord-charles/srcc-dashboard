...
function HeroGeometric({
  ...
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden bg-[#0A3A2A] ">
      <div className="absolute top-8 z-50 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
        <HeroPillSecond />
      </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <p className="text-base sm:text-lg md:text-xl text-white/40 mb-8 leading-relaxed font-light tracking-wide max-w-2xl mx-auto px-4">
              Strathmore Research and Consultancy Centre provides professional
              consulting services and innovative solutions to businesses and
              organizations.
            </p>
          </motion.div>
          ...
          >
            <Link href="/consultant/register/individual">
              <Button
                size="lg"
                className="bg-emerald-600 hover:bg-emerald-700 text-white min-w-[200px] h-12"
              >
                Register as Individual
              </Button>
            </Link>
            <Link href="/consultant/register/company">
              <Button
                size="lg"
                variant="outline"
      ...
      <div className="absolute inset-0 bg-gradient-to-t from-[#0A3A2A] via-transparent to-[#0A3A2A]/80 pointer-events-none" />
    </div>
  );
}
