...
const statuses: { value: ClaimStatus; label: string }[] = [
  ...
  {
    value: "pending_reviewer_approval",
    label: "Pending Reviewer Approval",
  },
  {
    value: "pending_approver_approval",
    label: "Pending Approver Approval",
  },
  {
    value: "pending_srcc_checker_approval",
    label: "Pending SRCC Checker Approval",
  },
  {
    value: "pending_srcc_finance_approval",
    label: "Pending SRCC Finance Approval",
  },
  {
  ...
  {
    value: "pending_academic_director_approval",
    label: "Pending Academic Director Approval",
  },
  {
