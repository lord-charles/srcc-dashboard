  ...
  const handleSubmit = async () => {
    if (receipts.length === 0) {
      toast({
        ...
        description:
          "Please add at least one receipt to submit accountability.",
      });
      return;
    }
    ...
    try {
      ...
      toast({
        ...
        description:
          "Your imprest accountability has been submitted successfully.",
      });
              ...
              <CardContent className="pt-4">
                ...
                <div className="flex justify-between items-center mb-4">
                  ...
                  <div className="text-sm">
                    ...
                    <span
                      className={`font-medium ml-2 ${getBalanceStatusColor()}`}
                    >
                      {new Intl.NumberFormat("en-US", {
                        style: "currency",
                        currency: "KES",
          ...
          <Card className="shadow-sm border-border/50 overflow-hidden mt-2">
            ...
            <CardContent className="pt-4">
              <p className="text-sm text-muted-foreground">
                {imprest.explanation || "No explanation provided"}
              </p>
            </CardContent>
          </Card>
                      ...
                      <TableRow key={index}>
                        ...
                        <TableCell>
                          <Input
                            ...
                            onChange={(e) =>
                              updateReceipt(index, "amount", e.target.value)
                            }
                            placeholder="0.00"
                            className="text-sm"
                            step="0.01"
