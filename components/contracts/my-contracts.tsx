                    ...
                    <div className="mt-3">
                      ...
                      >
                        <div
                          ...
                          style={{
                            width: `${
                              (activeContracts / (initialData.length || 1)) *
                              100
                            }%`,
                          }}
                        />
                    ...
                    <div className="mt-3">
                      ...
                      >
                        <div
                          ...
                          style={{
                            width: `${
                              (pendingContracts / (initialData.length || 1)) *
                              100
                            }%`,
                          }}
                        />
                  ...
                  <div className="p-0">
                    ...
                    <div className="mt-3">
                      <div className="flex items-center text-xs">
                        ...
                        <span className="ml-auto text-blue-600/70 dark:text-blue-400/70">
                          from last month
                        </span>
                      </div>
                    </div>
            ...
            <div className="flex items-center gap-2">
              ...
              {!isLoading && filteredAndSortedContracts.length > 0 && (
                <Badge variant="outline" className="text-xs font-normal">
                  ...
                  {filteredAndSortedContracts.length === 1
                    ? "contract"
                    : "contracts"}
                </Badge>
              )}
                      ...
                      <CardContent className="p-5">
                        ...
                        <div className="space-y-2.5 text-sm">
                          <div className="flex items-center text-gray-700 dark:text-gray-300">
                            ...
                            <span className="font-medium">{`${contract.contractValue.toLocaleString()} ${
                              contract.currency
                            }`}</span>
                          </div>
                          <div className="flex items-center text-gray-700 dark:text-gray-300">
                    ...
                    <tbody className="divide-y divide-gray-200 dark:divide-gray-800">
                      {filteredAndSortedContracts.map((contract) => {
                        ...
                        return (
                          <tr
                            key={contract._id}
                            className="hover:bg-gray-50 dark:hover:bg-gray-900/50 group"
                          >
                            <td className="px-4 py-3">
                              <div>
