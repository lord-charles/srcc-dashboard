...
export default async function ContractTemplatesSettingsPage() {
  const templates = await getContractTemplates({ active: true }).catch(
    () => [] as any[]
  );
    ...
    <div className="space-y-8">
      <section>
        ...
        <p className="text-sm text-muted-foreground mb-4">
          ...
          snapshots when awarding contracts.
        </p>
          ...
          >
            <div className="space-y-2">
              ...
              <input
                ...
                placeholder="Standard Team Member Contract"
              />
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2 md:col-span-2">
              ...
              <input
                name="variablesCsv"
                className="w-full border rounded px-3 py-2 bg-background"
                placeholder="PROJECT_NAME,EMPLOYEE_NAME,..."
              />
            </div>
            <div className="space-y-2 md:col-span-2">
